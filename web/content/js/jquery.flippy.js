/*
 *  modified by mousetwo
 *  1. @2014.10.28   *  make perspective always 0.
 *  
 */
...
(function ($) {
  ...
  var flipBox = function ($jO, opts, undefined) {
      ...
      if (this._noCSS || !_Support_CSS3) {
        ...
        this.jO
          ...
          .css({
            ...
            "perspective": 0		// mousetwo doestn't want the perspective effect, so he sets perspective as 0
          });
        this.jO.data("_oFlippy_", this);
    ...
    this.drawFlippyCSS = function () {
      ...
      // modified by cjp: 氓娄鈥毭ε九撁ぢ铰棵р€澛ぢ衡€犆р劉陆猫鈥奥裁ㄆ捙捗︹劉炉氓掳卤盲赂聧盲陆驴莽鈥澛╨ight忙鈥⑺喢ε九撁ぢ衡€�			
      if (this._isApplyLight) {
        this.applyLight();
      }
    ...
    //this.cvO;
    this._isApplyLight = opts.isApplyLight;	// add by cjp
