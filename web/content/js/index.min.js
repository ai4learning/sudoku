...
function Ka(a, b) {
  ...
  if (q && $("#current_module_unit").val() == a && h == D) {
    $("#unit_study_slide").append($($("#loading0").html()).css({
      position: "absolute",
      width: "100%",
      "margin-top": "10px"
...
function wordUse(a) {
    ...
    a = a.substr(39);
  R();
  b = "/Reading/Sentence?moduleCode\x3d" + b + "\x26unit\x3d" + a + "\x26level\x3d" + 1;
...
function Wb(a) {
  ...
  $("#handler-content div[name\x3dsentenceTest]").unbind("click").bind("click",
    function () {
      $(this).hasClass("solid-gray2") || wordUse($(this).attr("id"))
    });
    ...
    function () {
      if ($(this).hasClass("solid-gray2")) m('\x3cfont color\x3d"red"\x3e\u672c\u5355\u5143\u8fd8\u6ca1\u6709\u5b8c\u6210\u5b66\u4e60\uff0c\u6682\u65f6\u4e0d\u80fd\u6d4b\u8bd5\u3002\x3c/font\x3e');
        ...
        if (null != a && "" != a) {
          ...
          var b = a.substr(2, 36),
            a = a.substr(39);
          $.browser.msie ? (b = encodeURI("/#/user/test/unit?bookname\x3d" + $("#handle-title").html() + "\x26moduleCode\x3d" + b + "\x26unitNbr\x3d" + a), window.showModalDialog(b, "test", "dialogWidth\x3d" + pageWidth + ";dialogHeight\x3d" + pageHeight)) : window.open("/#/user/test/unit?bookname\x3d" + $("#handle-title").html() + "\x26moduleCode\x3d" + b + "\x26unitNbr\x3d" + a)
  ...
  if (h == A) null != f && 0 < f.length && null != a && "" != a ? f[f.length - 1].vocCode == a && f[f.length - 1].isSpelled ? (null != d && d.pauseClock(), q = !1, a = Ba(f), Ca(a, null)) : null == g || null == f[0].isFstReadSuccess ? null != d && d.pauseClock() : null != d ? (d.saveTime(), a = Ba(f), Ca(a, null), d.pauseClock()) : (a = Ba(f), Ca(a, null)) : null != d && (d.pauseClock(), d = null, q = !1);
    ...
    if (null != a && "" != a && null != b && "" != b && null != c && "" != c) if (x == Math.ceil(l.length / n) - 1 && f[f.length - 1].vocCode == a && f[f.length - 1].isSpelled) {
      ...
      null == g || 0 == x && !k ? (0 == $("#" + b + "-" + c).attr("isfinished") && $("#" + b + "-" + c).removeClass("unstudy-gray").removeClass("solid-gray2").addClass("studing-orange").unbind("click").click(function () {
        Ka(b + "-" + c)
      }), null != d && d.pauseClock()) : (e = JSON.stringify(ga()), null != d ? (d.saveTime(), k = "", g.isRead || 0 != g.vocIndex % n || 0 == x ? DB(b, c, a, e, TOTAL_READING_TIME, TOTAL_WRITING_TIME) : (k = null != l ? l[g.vocIndex - 1].vocCode : a, DB(b, c, k, e, TOTAL_READING_TIME, TOTAL_WRITING_TIME)), d.pauseClock()) : (k = "", null == !g.isRead && 0 == g.vocIndex % n && 0 != x ? (k = null != l ? l[g.vocIndex - 1].vocCode : a, DB(b, c, k, e, TOTAL_READING_TIME, TOTAL_WRITING_TIME)) : DB(b, c, a, e, TOTAL_READING_TIME, TOTAL_WRITING_TIME)))
  ...
  initialThemeMenu();
    ...
    rb = function(a, b, c) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                moduleCode: a || '00000000-0000-0000-0000-000000000000',
                extra: "dontdelete",
                unitNbr: b || 1,
                studytoken: I,
                isContinue: c || 0,
...
$(document).ready(function() {
        ...
        if(a) {
          ...
          if(y) {
            ...
            if(f.length > Ia && h == D) {
              ...
              ($("#seperateSectionOne").fadeIn(), $("#toNextStep").focus())
            }
          } else {
            if(f.length > Ia && h == D) {
              null != d && d.pauseClock(), dc(), fc()
            } else {
              if(Math.ceil(l.length / n) > x + 1) {
                ec()
              } else {
                d.pauseClock()
                Kb()
    ...
    function() {
        if (h == A) alert("\u6ca1\u6709\u8fd9\u4e2a\u9009\u9879");
            ...
            $("#current_module_unit").val("");
            null != a && null != c ? ($("#studyBox").omDialog("close"), $.browser.msie ? (a = encodeURI("/#/user/test/unit?bookname\x3d" + $("#handle-title").html() + "\x26moduleCode\x3d" + a + "\x26unitNbr\x3d" + c), window.showModalDialog(a, "test", "dialogWidth\x3d" + pageWidth + ";dialogHeight\x3d" + pageHeight)) : window.open("/#/user/test/unit?bookname\x3d" + $("#handle-title").html() + "\x26moduleCode\x3d" + a + "\x26unitNbr\x3d" + c)) : m("\u6d4b\u8bd5\u51fa\u9519\u4e86\uff0c\u5237\u4e2a\u526f\u672c\u8bd5\u8bd5~")
        }
    });
