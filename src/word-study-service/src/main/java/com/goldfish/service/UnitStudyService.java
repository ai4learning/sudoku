...
public interface UnitStudyService {
    ...
    SaveFinishUnitStudyVO doAjaxFinishSaveUnit(Integer studentId,
    ...
    RichUnitStudyVO getUnit(Integer userId, String moduleCode, Integer unit, RichUnitStudyVO richUnitStudyVO);
