...
import com.goldfish.servlet.CookieUtils;
import com.goldfish.servlet.context.LoginContext;
import com.goldfish.servlet.context.ExcludeReqstPath;
...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    private LoginContext createLoginContext(HttpServletResponse response, User user) {
        // 插入登录记录
        LoginRecord loginRecord = loginRecordService.refreshLoginRecord(user);
        LoginContext loginContext = LoginContext.getLoginContext();
        if (loginContext == null) {
            // 创建 新的LoginContext
