...
(function($,w){
	...
	$.extend(utils,{
		...
		/** 刷新面包屑 **/
		fRefleshBread:function(menuName){
			var _child=$("ul.breadcrumb li:first-child").children("span.menu");
			_child.html(menuName);
		},
 ...
 window.message_box = (function($) {
     ...
     that.init = function(options) {
     	...
     	'left:0px;right:0px;margin-left:auto;margin-right:auto;top:30px;z-index:10000;"><button type="button" class="close">&times;</button>'+
     	'<span></span></div>';
     	$("body").append(html);
